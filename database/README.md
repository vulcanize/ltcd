...
(http://godoc.org/github.com/vulcanize/ltcd/database)
...
(https://github.com/vulcanize/ltcd/tree/master/docs/json_rpc_api.md).
...
```bash
$ go get -u github.com/vulcanize/ltcd/database
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/vulcanize/ltcd/database#example-package--BasicUsage)  
  Demonstrates creating a new database and using a managed read-write
  transaction to store and retrieve metadata.

* [Block Storage and Retrieval Example]
  (http://godoc.org/github.com/vulcanize/ltcd/database#example-package--BlockStorageAndRetrieval)  
