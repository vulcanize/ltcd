...
(http://godoc.org/github.com/vulcanize/ltcd/peer)
...
```bash
$ go get -u github.com/vulcanize/ltcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/vulcanize/ltcd/peer#example-package--NewOutboundPeer)  
